...
test("loads existing state file", async () => {
    await writeFile(fileExisting, JSON.stringify({
        lastIndex: 2,
        history: [
...
test("save then reload state file", async () => {
    ...
    appendHistory(state, "https://b.s-ul.eu/y.png", "2026-08-10T04:00:00:000Z", 3)
    ...
    expect(stateReloaded.history).toEqual([{
        url: "https://b.s-ul.eu/y.png", changedAt: "2026-08-10T04:00:00:000Z"
    }])
})
